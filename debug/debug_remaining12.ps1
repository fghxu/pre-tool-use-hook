...
$indices = @(93, 94, 95, 96, 98, 99, 132, 181, 183, 184, 185, 186, 226)
foreach ($idx in $indices) {
    ...
    $short = ($command.Substring(0, [Math]::Min(150, $command.Length)) -replace "`n",' ')
    ...
    for ($i = 0; $i -lt [Math]::Min(8, $subs.Count); $i++) {
        $s = $subs[$i]
