...
- Baseline correction: redirect-strict is 25/25 (fixture and -Strictness strict both verified). The earlier "24/25 #22" note was stale — the `C:\temp\svc.txt` PSRemoting case lives in test-cases.xml as #687 ("temp path, always allowed") and passes; redirect-strict #22 has targeted `C:\some_dir\svc.txt` since a4ed09f.
